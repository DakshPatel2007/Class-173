  ...
  init: async function () {
    ...
    dishes.map(dish => {
      ...
      if (!dish.unavailable_days.includes(days[todaysDay])) {
        ...
        ratingPlane.setAttribute("material","#F0C30F");
        // Ratings
        var rating = document.createElement("a-entity");
        rating.setAttribute("id", `rating-${dish.id}`);
        rating.setAttribute("position", { x: 0, y: 0, z: 0 });
        rating.setAttribute("rotation", { x: -90, y: 0, z: 0 });
        ...
        reviewPlane.setAttribute("material","#F0C30F");
        ...
        review.setAttribute("visible", false);
